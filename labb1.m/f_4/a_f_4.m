...
% When using Trapets method we set θ=1/2 in our recursive solution,
% v_{n+1} = v_{n} + Δt((1 - θ)(Av_(n) + g_n) + θ(Av_{n+1} + g_{n+1}))
title(sprintf('Trapets method (θ = 1/2): Δt=%f, α=%f, n=%f, ', delta_max_ny, alpha, n));